...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      handleRedirect('/dashboard', 'Creating Custom Enclave...');
    } catch (err: any) {
          ...
          <div className="text-center">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full block bg-gradient-to-r from-purple-500 to-indigo-650 hover:from-purple-600 hover:to-indigo-700 text-white font-bold py-3.5 rounded-xl shadow-lg transition duration-200 text-sm"
              >
                Go to Dashboard
              </button>
              <button
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700 disabled:opacity-50 text-white font-bold py-3.5 rounded-xl shadow-lg transition duration-200 mt-2 flex items-center justify-center gap-2"
              >
                {isLoading ? (
                  <>
